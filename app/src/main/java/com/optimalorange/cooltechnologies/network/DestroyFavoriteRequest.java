 ...
 *
 */
public class DestroyFavoriteRequest extends SimpleRequest<JSONObject> {

    private static final int YOUKU_API_REQUEST_METHOD = Method.POST;

    private static final String YOUKU_API_DESTROY_FAVORITE
            = "https://openapi.youku.com/v2/videos/favorite/destroy.json ";

    private final Map<String, String> mParams;

    public DestroyFavoriteRequest(Map<String, String> params,
            Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        super(YOUKU_API_REQUEST_METHOD, YOUKU_API_DESTROY_FAVORITE, listener, errorListener);
        mParams = params;
    }
    ...
    public static class Builder {
        ...
        public DestroyFavoriteRequest build() {
            return new DestroyFavoriteRequest(buildParams(), mResponseListener, mErrorListener);
        }
